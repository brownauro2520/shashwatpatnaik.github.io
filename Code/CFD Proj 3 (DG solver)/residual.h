...
vector<double> PhiNV,
vector<double> PhiCV,
vector<double> GPhiNV,
vector<double> wqN,
vector<double> GPhiCV,
vector<double> wqC,
vector<double> wq1N,
vector<double> wq1C,
...
vector<double> J_edge_matrix)
{
	...
	int NqN = PhiNV.size()/Np;
	// Get the size of the vector
	int NqC = PhiCV.size()/Np;
