...
// int N = E2N.size();
// std::vector<std::vector<double>> iM {{1.1,1.2, 1.3}, //Edge1, 1quad, 1,2,3basis
// 							{2.1,2.2, 2.3}, //Edge1, 2quad, 1,2,3basis
// 							{3.1,3.2, 3.3},
//                             {1.1,1.2, 1.3}, //Edge1, 1quad, 1,2,3basis
// 							{2.1,2.2, 2.3}, //Edge1, 2quad, 1,2,3basis
// 							{3.1,3.2, 3.3}};
...
for (int i = 0; i < N*Np; i++) {
        U1[i] = add_v(U0[i],(scalarV(F0[i],R0.second[floor(i/(Np))])));
        }
...
std::vector<std::vector<double>> Ufinal(F0.size(), std::vector<double>(4));
      for (int i = 0; i < N*Np; i++) {
        ...
        vector<double> eq1 = scalarV(f,0.5*R0.second[floor(i/(Np))]);
