...
if __name__ == "__main__":
    iter_history = []; functioncall_history = []; wall_time_history = []
    iter_historys = []; functioncall_historys = []; wall_time_historys = []
    rosen_dim = [2, 4, 8, 16, 32, 64, 128, 256, 300, 400, 512]
    for n in rosen_dim:
        ...
        x0 = ones_vector(n,0)
        func = FunctionWrapperWithCounter(func_rosen)
        func_name = str(n) + 'D Rosenbrock Function'
        options = 'quasi_bt'
        ...
        print(outputs["namesearchdir"], outputs["namelinesearch"], func_name)
        ...
        # Extract from the 'output' dictionary
        iter = outputs['iteration']
        iter_history.append(iter)

        functioncall_history.append(func.get_fcalls())

        # Calculate the execution time
        execution_time = end_time - start_time
        wall_time_history.append(execution_time)
        ...
        # Extract from the 'output' dictionary
        iter = outputs['iteration']
        iter_historys.append(iter)

        functioncall_historys.append(func.get_fcalls())

        # Calculate the execution time
        execution_time = end_time - start_time
        wall_time_historys.append(execution_time)
    ...
    axes[0].plot(rosen_dim, iter_history, 'bo-', label='Quasi-Newton with BackTracking')
    axes[0].plot(rosen_dim, iter_historys, 'ro-', label='BFGS')
    axes[0].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_ylabel('Number of Iteration', fontsize=14, fontname='Times New Roman')
    axes[0].legend()

    # Plot the second subplot on the right
    axes[1].semilogx(rosen_dim, iter_history, 'bo-')
    axes[1].semilogx(rosen_dim, iter_historys, 'ro-')
    axes[1].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[1].set_title('Log-x Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_ylabel('Number of Iteration', fontsize=14, fontname='Times New Roman')
    plt.tight_layout()
    plt.show()
    ...
    # Plot the first subplot on the left
    axes[0].plot(rosen_dim, functioncall_history, 'bo-', label='Quasi-Newton with BackTracking')
    axes[0].plot(rosen_dim, functioncall_historys, 'ro-', label='Scipy BFGS')
    axes[0].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_ylabel('Number of Function calls', fontsize=14, fontname='Times New Roman')
    axes[0].legend()

    # Plot the second subplot on the right
    axes[1].semilogx(rosen_dim, functioncall_history, 'bo-')
    axes[1].semilogx(rosen_dim, functioncall_historys, 'ro-')
    axes[1].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[1].set_title('Log-x Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_ylabel('Number of Function calls', fontsize=14, fontname='Times New Roman')
    plt.tight_layout()
    plt.show()
    ...
    # Plot the first subplot on the left
    axes[0].plot(rosen_dim, wall_time_history, 'bo-', label='Quasi-Newton with BackTracking')
    axes[0].plot(rosen_dim, wall_time_historys, 'ro-', label='Scipy BFGS')
    axes[0].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[0].set_ylabel('Wall Time (sec)', fontsize=14, fontname='Times New Roman')
    axes[0].legend()

    # Plot the second subplot on the right
    axes[1].semilogx(rosen_dim, wall_time_history, 'bo-')
    axes[1].semilogx(rosen_dim, wall_time_historys, 'ro-')
    axes[1].set_xlabel('Rosenbrock Function Dimension', fontname='Times New Roman', fontsize=14)
    #axes[1].set_title('Log-x Convergence Plot of N-D Rosenbrock Function\n' + outputs["namesearchdir"] + '-' + outputs["namelinesearch"] + r' with a $x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_title('Convergence Plot of N-D Rosenbrock Function\n' r'$x_0$ = $[0_{dimension}]$', fontname='Times New Roman', fontsize=14)
    axes[1].set_ylabel('Wall Time (sec)', fontsize=14, fontname='Times New Roman')
    plt.tight_layout()
    plt.show()
