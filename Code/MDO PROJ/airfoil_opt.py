...
parser.add_argument("--opt", type=str, default="IPOPT", choices=["SLSQP", "SNOPT"])
parser.add_argument("--gridFile", type=str, default="n0012_flatc.cgns")
...
FFDFile = "ffd_flat.xyz"

DVGeo = DVGeometry(FFDFile)
DVGeo.addLocalDV("shape", lower=-0.1, upper=0.2, axis="y", scale=1.0)
...
optProb.addCon("cl_con_" + ap.name, lower=0.0, upper=0.2, scale=1.0)
